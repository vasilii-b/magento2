...
class ImageTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->context = $this->getMock(\Magento\Framework\Model\Context::class);
        ...
        $this->filesystem = $this->getMock(\Magento\Framework\Filesystem::class);
        $this->filesystem->expects($this->once())->method('getDirectoryWrite')
            ->with(DirectoryList::MEDIA)
            ->will($this->returnValue($this->mediaDirectory));
        $this->factory = $this->getMock(\Magento\Framework\Image\Factory::class);
